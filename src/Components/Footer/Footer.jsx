...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-base-200 text-base-content  text-base sm:grid grid-cols-2 gap-5">
                <div>
                    <svg style={{ width: '100px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 24" role="img" aria-labelledby="a1ae9t0b2ti7fvcasuxktascdh6ovjpz" className="icon dribbble-wordmark ">
                        <title id="a1ae9t0b2ti7fvcasuxktascdh6ovjpz">Dribbble: the community for graphic design</title>
                    ...
                    <p>Dribbble is the world’s leading <br /> community for creatives to share, grow, <br /> and get hired.</p>
                ...
                <div>
                    <span className="font-bold">Hire designers</span>
                    ...
                    <a className="link link-hover font-bold">Brands</a>
                ...
                <div>
                    <span className="font-bold">Directories</span>
                    ...
                    <a className="link link-hover font-bold">Design assets</a>
                    <a className="link link-hover">Dribbble Marketplace</a>
                    <a className="link link-hover">Creative Market</a>
                    <a className="link link-hover">Fontspring</a>
                    <a className="link link-hover">Font Squirrel</a>
                </div>
                <div>
                    <span className="font-bold">Design Resources</span>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300 ">
                ...
                <div className=" flex items-center md:place-self-center md:justify-self-end">
                    <p><span className='font-bold'>21,732,011</span> shots dribbbled</p>
                    <div className="grid grid-flow-col gap-4">
                        <img class="dribbble-ball ls-is-cached lazyloaded" data-src="https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg" width="24px" height="24px" alt="Dribbble ball icon" src="https://cdn.dribbble.com/assets/dribbble-ball-icon-4e54c54abecf8efe027abe6f8bc7794553b8abef3bdb49cd15797067cf80ca53.svg" />
                    </div>
                </div>
            </footer>
        </div>
